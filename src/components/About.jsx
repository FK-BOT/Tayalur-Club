            ...
            <div className="container">
                <div style={{
                    ...
                    >
                        ...
                        <p style={{ marginBottom: '1rem', color: '#ccc', lineHeight: '1.8' }}>
                            The Tayalur Club brings together members of the Tayalur community, known for its hard work, cultural pride, and strong sense of unity. Originating from Tayalur, near Mulbagal in Kolar District, Karnataka, the community has grown far beyond its hometown.
                        </p>
                        <p style={{ marginBottom: '1rem', color: '#ccc', lineHeight: '1.8' }}>
                            While Mulbagal developed into a larger and more prominent town, the Tayalur community has distinguished itself through remarkable achievements in business, trade, and social welfare. Their commitment to progress, integrity, and mutual support has helped them thrive wherever they have settled.
                        </p>
                        <p style={{ marginBottom: '1rem', color: '#ccc', lineHeight: '1.8' }}>
                            Today, the Tayalur community has expanded across the globe, with members established in Saudi Arabia, the Gulf countries, Europe, the United States, the United Kingdom, Canada, and South Africa.
                        </p>
                        <p style={{ marginBottom: '1rem', color: '#ccc', lineHeight: '1.8' }}>
                ...
                <div style={{ marginTop: '5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                    ...
                    >
                        ...
                        <p style={{ color: '#ccc', lineHeight: '1.6' }}>
                            The Tayalur Club (TTC) envisions a world where Tayalur community members, enriched by education, health, stability, and dignity, lead meaningful lives that inspire harmony, progress, and positive change in society.
                        </p>
                    </motion.div>
                </div>
